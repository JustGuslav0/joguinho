...
function moverladrao() {
  ...
  ladraoPositionX -= 3; // Movimento para a esquerda
...
function moverladraozinho() {
  ladraozinho.style.right = ladraozinhoPositionX + 'px';
...
function moverkenny() {
  ...
  kennyPositionX -= 1; // Movimento para a esquerda
...
function addVida() {
    ...
    if (vidaCount >= 10){
       window.location.href='telinhaTresCartman.html';
    }
  }
